...
func Test_Before(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "test time instant 2019-01-01 isn't before than 2010-01-01 and won't pass validation rule",
			field:       "birth_date",
			value:       "2019-01-01",
		...
		{
			name:        "test time instant 2022-02-01 isn't before than 2022-01-01 and won't pass validation rule",
			field:       "birth_date",
			value:       "2022-02-01",
